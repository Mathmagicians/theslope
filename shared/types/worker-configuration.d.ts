/* eslint-disable */
// Generated by Wrangler by running `wrangler types shared/types/worker-configuration.d.ts` (hash: 415ad76d714e2fcc4518441d15de106a)
// Runtime types generated with workerd@1.20260915.1 2026-09-16 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	SENDER: Queue;
	ASSETS: Fetcher;
	DEPLOY_URL?: "https://dev.skraaningen.dk" | "https://www.skraaningen.dk";
	NUXT_NOTIFICATIONS_ENVIRONMENT?: "dev" | "prod";
	NUXT_NOTIFICATIONS_FROM?: "no-reply.dev@skraaningen.dk" | "no-reply@skraaningen.dk";
	NUXT_NOTIFICATIONS_FROM_NAME?: "Skråningen dev" | "Skråningen";
	HEY_NABO_USERNAME: string;
	HEY_NABO_EJ_ADMIN_USERNAME: string;
	HEY_NABO_PASSWORD: string;
	NUXT_PUBLIC_HEY_NABO_API: string;
	THE_SLOPE_API: string;
	DB_D1_NAME: string;
	DB_D1_ID: string;
	DATABASE_URL: string;
	NUXT_SESSION_PASSWORD: string;
	NUXT_GITHUB_TOKEN: string;
	CLOUDFLARE_BYPASS_TOKEN: string;
	BASE_URL: string;
}
declare namespace Cloudflare {
	interface DevEnv {
		...
		NUXT_NOTIFICATIONS_ENVIRONMENT: "dev";
		NUXT_NOTIFICATIONS_FROM: "no-reply.dev@skraaningen.dk";
		NUXT_NOTIFICATIONS_FROM_NAME: "Skråningen dev";
		HEY_NABO_USERNAME: string;
		HEY_NABO_EJ_ADMIN_USERNAME: string;
		HEY_NABO_PASSWORD: string;
		NUXT_PUBLIC_HEY_NABO_API: string;
	...
	interface ProdEnv {
		...
		NUXT_NOTIFICATIONS_ENVIRONMENT: "prod";
		NUXT_NOTIFICATIONS_FROM: "no-reply@skraaningen.dk";
		NUXT_NOTIFICATIONS_FROM_NAME: "Skråningen";
		HEY_NABO_USERNAME: string;
		HEY_NABO_EJ_ADMIN_USERNAME: string;
		HEY_NABO_PASSWORD: string;
		NUXT_PUBLIC_HEY_NABO_API: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOY_URL" | "NUXT_NOTIFICATIONS_ENVIRONMENT" | "NUXT_NOTIFICATIONS_FROM" | "NUXT_NOTIFICATIONS_FROM_NAME" | "HEY_NABO_USERNAME" | "HEY_NABO_EJ_ADMIN_USERNAME" | "HEY_NABO_PASSWORD" | "NUXT_PUBLIC_HEY_NABO_API" | "THE_SLOPE_API" | "DB_D1_NAME" | "DB_D1_ID" | "DATABASE_URL" | "NUXT_SESSION_PASSWORD" | "NUXT_GITHUB_TOKEN" | "CLOUDFLARE_BYPASS_TOKEN" | "BASE_URL">> {}
}
