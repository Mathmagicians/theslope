...
| **Admin - Households** | | | | | **✅ FULLY COMPLIANT (2025-11-11)** - Inhabitants only |
| `/api/admin/household/[id].delete.ts` | ✅ | ✅ | ✅ | N/A | deleteHousehold() → Household (no E2E tests yet) |
| `/api/admin/household/[id].get.ts` | ✅ | ✅ | ✅ | N/A | fetchHousehold() → HouseholdWithInhabitants (no E2E tests yet) |
| `/api/admin/household/[id].post.ts` | ✅ | ✅ | ✅ | N/A | updateHousehold() → Household (no E2E tests yet) |
| `/api/admin/household/index.get.ts` | ✅ | ✅ | ✅ | N/A | fetchHouseholds() → HouseholdSummary[] (no E2E tests yet) |
| `/api/admin/household/index.put.ts` | ✅ | ✅ | ✅ | N/A | saveHousehold() → Household (no E2E tests yet) |
...
| `/api/admin/allergy-type/index.get.ts` | ✅ | ✅ | ✅ | ✅ | fetchAllergyTypes() validates with AllergyTypeWithInhabitantsSchema |
| `/api/admin/allergy-type/[id].get.ts` | ✅ | ✅ | ✅ | ✅ | fetchAllergyType() validates with AllergyTypeResponseSchema |
| `/api/admin/allergy-type/index.put.ts` | ✅ | ✅ | ✅ | ✅ | createAllergyType() validates with AllergyTypeResponseSchema |
| `/api/admin/allergy-type/[id].post.ts` | ✅ | ✅ | ✅ | ✅ | updateAllergyType() validates with AllergyTypeResponseSchema |
| `/api/admin/allergy-type/[id].delete.ts` | ✅ | ✅ | ✅ | ✅ | deleteAllergyType() validates with AllergyTypeResponseSchema |
