/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/sender/wrangler.toml workers/sender/worker-configuration.d.ts` (hash: 3655ac32437db925c3a170ebcaf8def7)
