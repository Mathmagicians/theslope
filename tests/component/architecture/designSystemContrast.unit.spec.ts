...
const KNOWN_FINDINGS = new Map<string, number>([
    ...
    ['light|BACKGROUNDS.landing.titleBar|self', 3.55],
    ...
    ['light|BACKGROUNDS.landing.section3|self', 4.07],
    ...
    ['dark|BACKGROUNDS.landing.titleBar|self', 3.55],
    ...
    ['dark|BACKGROUNDS.landing.section3|self', 4.07],
